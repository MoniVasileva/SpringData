...
public class EntityManager<E> implements DBContext<E> {
    ...
    public boolean persist(E entity) throws SQLException, IllegalAccessException {
        ...
        String valueList = this.getGetValuesWithoutIdentity(entity);
    ...
    @Override
    private void doCreate(Class<E> entity) {
      final  String tableName = getTableName(entity);

      getAllFieldsAndTypesInKeyValuePairs(entity);
    }

    private void getAllFieldsAndTypesInKeyValuePairs(Class<E> entity) {
        getAllFieldsWithoutId(entity);
    }

    private List<KeyValue> getAllFieldsWithoutId(Class<E> entity) {
    }
    ...
    private String getGetValuesWithoutIdentity(E entity) throws IllegalAccessException {
